...
class SiteController extends Controller
{
	...
	public function actionContact()
	{
		...
		$records = ContactReason::model()->findAll();
    	$list = CHtml::listData($records, 'id', 'description');
		if(isset($_POST['ContactForm']))
		{
			...
			if($model->validate())
			{
				...
				$reason='=?UTF-8?B?'.base64_encode($model->reason).'?=';
		...
		$this->render('contact',array('model'=>$model,'list'=>$list));
	}
